...
response = requests.get('https://api.apiverve.com/v1/seovalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/seovalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/seovalidator](https://docs.apiverve.com/ref/seovalidator)
